...
$pelanggan = query("SELECT * FROM pelanggan WHERE kode_pelanggan = '$kode_pelanggan'")[0];
           ...
           <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"><i class="fa fa-truck fa-fw"></i> Ubah Data Pelanggan</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                     <div class="form-group">
						...
						<input class="form-control" placeholder="Kode Pelanggan" name="kode_pelanggan" id="kode_pelanggan" value="<?php echo $pelanggan["kode_pelanggan"] ?>" readonly>
					</div>
					<div class="form-group">
						<label for="nama_pelanggan">Nama Pelanggan</label>
						<input class="form-control" placeholder="Nama Pelanggan" name="nama_pelanggan" id="nama_pelanggan" value="<?php echo $pelanggan["nama_pelanggan"] ?>" autocomplete="off" autofocus required>
					</div>
					<div class="form-group">
						<label for="alamat">Alamat</label>
						<textarea class="form-control" rows="3" placeholder="Alamat" name="alamat" id="alamat" required><?php echo $pelanggan["alamat"] ?> </textarea>
					</div>
					<div class="form-group">
						<label for="telepon">Telepon</label>
						<input class="form-control" placeholder="Telepon" name="telepon" id="telepon" value="<?php echo $pelanggan["telepon"] ?>" autocomplete="off" required>
					</div>
					<button type="submit" class="btn btn-danger" name="ubah_pelanggan">Ubah Pelanggan</button>
                    </form>
				</div>
        </div>
        <!-- /#wrapper -->

            ...
            <div id="page-wrapper">
                <div class="container-fluid">
					...
					<div class="form-group">
						...
						<input type="number" class="form-control" placeholder="Stok" name="stok" id="stok" value="<?php echo $barang["stok"] ?>" autocomplete="off" required>
					</div>
					<button type="submit" class="btn btn-danger" name="ubah_barang">Ubah Barang</button>
                    </form>
				</div>
        </div>
        <!-- /#wrapper -->

...
$jual = query("SELECT * FROM jual INNER JOIN detail_jual ON jual.kode_jual = detail_jual.kode_jual INNER JOIN pelanggan ON jual.kode_pelanggan = pelanggan.kode_pelanggan INNER JOIN admin ON jual.kode_admin = admin.kode_admin INNER JOIN barang ON barang.kode_barang = detail_jual.kode_barang ORDER BY jual.kode_jual ASC");
           ...
           <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"><i class="fa fa-money fa-fw"></i> Data Penjualan</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <a href="transaksi.php"><button type="button" class="btn btn-danger"><i class="fa fa-plus"></i> Input Penjualan</button></a>
                                </div>
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><div align="center">Admin</div></th>
                                                    <th><div align="center">Pelanggan</div></th>
                                                    <th><div align="center">Barang</div></th>
                                            ...
                                            <tr>
                                                ...
                                                <td align="right"><?php echo rupiah($row["subtotal"]); ?></td>
                                            </tr>

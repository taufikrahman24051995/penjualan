           ...
           <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"><i class="fa fa-briefcase fa-fw"></i> Data Barang</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <a href="barang_input.php"><button type="button" class="btn btn-danger"><i class="fa fa-plus"></i> Input Barang</button></a>
                                </div>
                                <!-- /.panel-heading -->
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                        <a style="text-decoration: none; color: white;" href="barang_ubah.php?kode_barang=<?php echo $row["kode_barang"]; ?>">
                                                        <button class="btn btn-primary">
                                                        <i class="fa fa-edit"></i> Ubah
                                                        </button>
                                                        </a>
                                                        |
                                                        <a style="text-decoration: none; color: white;" href="barang_hapus.php?kode_barang=<?php echo $row["kode_barang"]; ?>" onclick="return confirm('Hapus data barang');" >
